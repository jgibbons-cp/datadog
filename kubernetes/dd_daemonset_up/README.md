...
that asked for in regards to the Datadog agent.  This idea was explored in the article [Kubernetes: Do not Schedule Pods until the Datadog Agent is Running](NEET LINK).  
...
policy that blocks Deployments in most namespaces.  
